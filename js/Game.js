class Game {
  ...
  showFuelBar() {
    push();
    image(fuelImage, width / 2 - 130, height - player.positionY - 190, 20, 20);
    fill("white");
    rect(width / 2 - 100, height - player.positionY - 190, 185, 20);
    fill("#ffc400");
    rect(width / 2 - 100, height - player.positionY - 190, player.fuel, 20);
    noStroke();
    pop();
  }
  ...
  showLife() {
    push();
    image(lifeImage, width / 2 - 130, height - player.positionY - 160, 20, 20);
    fill("white");
    rect(width / 2 - 100, height - player.positionY - 160, 185, 20);
    fill("#f50057");
    rect(width / 2 - 100, height - player.positionY - 160, player.life, 20);
    noStroke();
    pop();
  }
